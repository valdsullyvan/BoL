...
if AUTOUPDATE then
    SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/swan524/BotOfLegend/kog/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/swan524/BotOfLegend/kog/master/version/"..SCRIPT_NAME..".version"):CheckUpdate()
end
...
function OnLoad()
	...
	SendMessage("This script is further updated by swan524 on BoL forums.")
